...
// This is the kube-workspaces fork of github.com/webview/webview_go. The single
// deliberate change from upstream (v0.0.0-20240831120633-6173450d4dd6) is the
// pkg-config below: webkit2gtk-4.0 -> webkit2gtk-4.1, because Ubuntu 24.04+ and
// Debian 12+ ship only WebKitGTK 4.1 (libsoup3) and the 4.0 runtime is gone.
// Everything else, including the Windows/macOS backends, is upstream-identical.
// See README/AGENTS under "third_party" before touching anything here.
