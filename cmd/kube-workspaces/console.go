...
// consoleHandleUsable reports whether a Windows standard handle actually
// refers to something the process can read from or write to.
//
...
// call failed) — those are the cases where attachParentConsole should point the
...
//
// Only console_windows.go calls this; it lives in a platform-neutral file
// because the rule is worth testing on the machines this code is written on.
func consoleHandleUsable(h uintptr) bool {
